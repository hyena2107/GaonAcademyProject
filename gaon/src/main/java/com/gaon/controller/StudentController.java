...
import com.gaon.service.StudentService;
...
public class StudentController {
	...
	public String studentAdd(HttpSession session) { 
		...
		//views 와 .jsp 되어있음.(실제경로)
	}
	
	
	// 학생등록하기.
		@RequestMapping(value = "/studentregister.action", method = RequestMethod.POST)
		@ResponseBody
		public String studnetRegister(StudentVo vo) {
			studentService.studentRegisterService(vo);
			return "";
		}
	...
	// 담당 강의리스트
	@RequestMapping(value = {"/checkcourse.action"}, method = RequestMethod.GET)
	public String courseList(String teacherName,Model model) {
		
		List<CourseVO> courselist=studentService.courseListService(teacherName);
		model.addAttribute("courses", courselist); 
		
		
		
		return "student/checkcourse";
	}
	...
	//add 세션시 필요한거
	@RequestMapping(value = {"/addsession.action"}, method = RequestMethod.GET)
...
//	
//	@RequestMapping(value = {"/checkstudent.action"},  method = RequestMethod.GET)
//	public String checklist(StudentVo vo) {
//		List<StudentVo> list = studentService.studentListService();	
//		
//		return "student/checkstudent";
//	}
